...
Customer-owned Software Assurance core counts are supplied through two portable
Power Query parameters and are deliberately separated from Arc billing
metadata. The existing `ESU Forecast` page compares those trusted inputs with
current Database Engine usage and forecast Azure Hybrid Benefit core demand.
Follow the [licensing input setup](LICENSING-INPUTS.md) to configure the
edition-covered core counts.
