...
Four focused pages are generated by `tools/build-layout.mjs`, using the
...
- `Licensing Position` - customer-declared Software Assurance evidence,
  Database Engine and SSIS core separation, Azure Hybrid Benefit eligibility,
  covered/uncovered Engine core reconciliation, and cost-assumption disclosures.
...
Customer-declared Software Assurance evidence is supplied through portable
Power Query parameters and is deliberately separated from Arc billing
metadata. Follow the [licensing declaration setup](LICENSING-INPUTS.md) to
configure SA status, edition-covered cores, evidence, and assessment metadata.
